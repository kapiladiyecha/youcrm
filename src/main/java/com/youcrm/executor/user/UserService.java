...

    {
        ...
        try
        {
            ...
            while (resultSet.next()) {
                ...
                row.add("<a href='#' data-toggle='modal' data-target='#myModal' data-value='"+ userId +"' id='"+ userId +"' class='update btn-action glyphicons pencil btn-success'><i></i></a> &nbsp; <a href='#' id='"+ userId +"' data-value='"+ userId +"' class=' delete btn-action glyphicons remove_2 btn-danger'><i></i></a>");
